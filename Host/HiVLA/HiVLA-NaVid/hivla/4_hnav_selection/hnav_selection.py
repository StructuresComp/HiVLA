...
def main():
    ...
    parser.add_argument(
        "--entropy_dir",
        default="vlnce_baselines/hivla/2_data_extraction/outputs",
        help="Step 2 output dir (anomaly_metrics_chunk*.jsonl)",
    )
    parser.add_argument(
        "--gt_dir",
        default="vlnce_baselines/hivla/3_gt_labeling/outputs",
        help="Step 3 output dir (episode_diagnostics.jsonl)",
    )
    parser.add_argument(
        "--output_dir",
        default="vlnce_baselines/hivla/4_hnav_selection/outputs",
