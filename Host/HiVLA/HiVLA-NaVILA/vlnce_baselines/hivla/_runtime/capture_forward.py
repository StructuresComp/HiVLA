"""
Attention capture for visualization (temp_helper.py style).
"""
...
def _capture_attn_forward(
    ...
    **kwargs
    ...
    """
    Capture-only attention forward (temp_helper.py style).
    Captures attention weights for specified heads during prefill.
    """
    ...
    # Causal mask — squeeze to [bsz, q_len, kv_len] for per-head computation
    ...
    for h in range(self.num_heads):
        ...
        # Capture instr→img attention (vis_heads=None → all heads)
