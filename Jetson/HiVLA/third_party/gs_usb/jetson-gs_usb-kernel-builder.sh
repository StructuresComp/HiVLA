...
if [ ! -f "public_sources.tbz2" ]; then
    ...
    wget --show-progress -q https://developer.nvidia.com/downloads/embedded/l4t/r36_release_v4.4/sources/public_sources.tbz2
else
